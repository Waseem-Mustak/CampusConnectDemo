...
const NotificationsPage = () => {
	...
	const renderRelatedPost = (relatedPost) => {
		...
		const trimmedText = relatedPost.content?.length > 20
										...
										<div className='flex items-center space-x-4'>
											...
											<div className='flex flex-col w-full overflow-hidden'>
												<div className='flex items-center gap-2 flex-wrap break-words'>
													...
													<p className='text-sm break-words'>{renderNotificationContent(notification)}</p>
												</div>
												...
												<div
													...
													onClick={() => markAsReadMutation(notification._id)} // When clicked, mark notification as read
												>
